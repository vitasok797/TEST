...
Git will prompt you to log22 in using a browser window. You may first be asked to authorize an OAuth app.
...
Git will not require you to type your credentials in the command line again unless you change your credentials.xxxx